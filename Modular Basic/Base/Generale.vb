...
Module Generale
    ...
    Public _CodeGen As New StringBuilder()
    Public _LibGen As New StringBuilder()
    ...
    Public Class VBTypesHandler
        ...
        Public Function GetTypeCode(typeName As String) As Integer
            Select Case typeName.ToUpper()
                ...
                Case "OBJECT"
                    Return TYPE_OBJECT
                Case Else
                    Throw New ArgumentException($"Tipo non supportato: {typeName}")
            End Select
        End Function
        ...
        Public Function GetMaxValue(typeName As String) As String
            Select Case typeName.ToUpper()
                Case "INTEGER"
                    Return "2147483647"
                Case "UINTEGER"
                ...
                Case "USHORT"
                    Return "65535"
                Case Else
                    Throw New ArgumentException($"Tipo non supportato per MaxValue: {typeName}")
            End Select
        End Function

        Public Function GetMinValue(typeName As String) As String
            Select Case typeName.ToUpper()
                Case "INTEGER"
                    Return "-214783648"
                Case "UINTEGER"
                ...
                Case "USHORT"
                    Return "0"
                Case Else
                    Throw New ArgumentException($"Tipo non supportato per MinValue: {typeName}")
            End Select
        End Function
    End Class
